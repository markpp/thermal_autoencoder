...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_list", type=str, default="data/train_both.txt", help="View root directory")
    ...
    dm = HarbourDataModule(image_list=args.image_list, batch_size=args.batch_size)
    dm.setup()
